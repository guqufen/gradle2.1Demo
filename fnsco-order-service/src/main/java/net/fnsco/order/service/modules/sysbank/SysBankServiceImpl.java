package net.fnsco.order.service.modules.sysbank;
...
public class SysBankServiceImpl extends BaseService implements SysBankService {
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysbank.SysBankService#deleteByPrimaryKey(java.lang.Integer)
     * @auth tangliang
     * @date 2017年7月7日 上午10:56:16
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysbank.SysBankService#insert(net.fnsco.order.service.domain.SysBank)
     * @auth tangliang
     * @date 2017年7月7日 上午10:56:16
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysbank.SysBankService#insertSelective(net.fnsco.order.service.domain.SysBank)
     * @auth tangliang
     * @date 2017年7月7日 上午10:56:16
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysbank.SysBankService#selectByPrimaryKey(java.lang.Integer)
     * @auth tangliang
     * @date 2017年7月7日 上午10:56:16
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysbank.SysBankService#updateByPrimaryKeySelective(net.fnsco.order.service.domain.SysBank)
     * @auth tangliang
     * @date 2017年7月7日 上午10:56:16
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysbank.SysBankService#updateByPrimaryKey(net.fnsco.order.service.domain.SysBank)
     * @auth tangliang
     * @date 2017年7月7日 上午10:56:16
     */
    @Override
     ...
     * @see net.fnsco.order.api.sysbank.SysBankService#queryPageList(net.fnsco.order.service.domain.SysBank, int, int)
     * @auth tangliang
