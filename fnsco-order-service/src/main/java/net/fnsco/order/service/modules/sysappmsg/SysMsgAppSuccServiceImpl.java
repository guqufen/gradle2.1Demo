...
public class SysMsgAppSuccServiceImpl extends BaseService implements SysMsgAppSuccService {
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysappmsg.SysMsgAppSuccService#deleteByPrimaryKey(java.lang.Integer)
     * @auth tangliang
     * @date 2017年7月19日 下午3:23:23
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysappmsg.SysMsgAppSuccService#insert(net.fnsco.order.service.domain.SysMsgAppSucc)
     * @auth tangliang
     * @date 2017年7月19日 下午3:23:23
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysappmsg.SysMsgAppSuccService#insertSelective(net.fnsco.order.service.domain.SysMsgAppSucc)
     * @auth tangliang
     * @date 2017年7月19日 下午3:23:23
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysappmsg.SysMsgAppSuccService#selectByPrimaryKey(java.lang.Integer)
     * @auth tangliang
     * @date 2017年7月19日 下午3:23:23
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysappmsg.SysMsgAppSuccService#updateByPrimaryKeySelective(net.fnsco.order.service.domain.SysMsgAppSucc)
     * @auth tangliang
     * @date 2017年7月19日 下午3:23:23
     */
    @Override
    ...
    /**
     * (non-Javadoc)
     * @see net.fnsco.order.api.sysappmsg.SysMsgAppSuccService#updateByPrimaryKey(net.fnsco.order.service.domain.SysMsgAppSucc)
     * @auth tangliang
     * @date 2017年7月19日 下午3:23:23
     */
    @Override
