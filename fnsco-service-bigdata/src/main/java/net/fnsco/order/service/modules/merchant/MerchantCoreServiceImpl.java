...
import net.fnsco.order.service.dao.master.AgentDao;
...
public class MerchantCoreServiceImpl implements MerchantCoreService {
     ...
     * @see net.fnsco.order.api.merchant.MerchantCoreService#doAdd(net.fnsco.order.service.domain.MerchantCore, int)
     */
    @Override
    @Transactional
     ...
     * @see net.fnsco.order.api.merchant.MerchantCoreService#queryMerchantCore(net.fnsco.order.service.domain.MerchantCore)
     */
    @Override
     ...
     * @see net.fnsco.order.api.merchant.MerchantCoreService#queryAllByCondition(net.fnsco.order.service.domain.MerchantCore)
     */
    @Override
     ...
     * @see net.fnsco.order.api.merchant.MerchantCoreService#deleteByIds(java.lang.Integer[])
     */
    @Transactional
    @Override
     ...
     * @see net.fnsco.order.api.merchant.MerchantCoreService#
    ...
    /**
     * (non-Javadoc)查询所有代理商
     * @see net.fnsco.order.api.merchant.MerchantCoreService#queryAllAgent()
     * @auth tangliang
...
//        merchantTerminal.setMercReferName(request.getParameter("mercReferName"));
     ...
     * @see net.fnsco.order.api.merchant.MerchantCoreService#doAddMerCore(net.fnsco.order.service.domain.MerchantCore)
     * @auth tangliang
    ...
    /**
     * (non-Javadoc)保存联系信息
     * @see net.fnsco.order.api.merchant.MerchantCoreService#doAddMerContact(java.util.List)
     * @auth tangliang
    ...
    /**
     * (non-Javadoc)保存终端信息
     * @see net.fnsco.order.api.merchant.MerchantCoreService#doAddMerTerminal(java.util.List)
     * @auth tangliang
    ...
    /**
     * (non-Javadoc)保存渠道信息
     * @see net.fnsco.order.api.merchant.MerchantCoreService#doAddChannel(java.util.List)
     * @auth tangliang
    ...
    /**
     * (non-Javadoc) 保存银行卡信息
     * @see net.fnsco.order.api.merchant.MerchantCoreService#doAddMerBanks(java.util.List)
     * @auth tangliang
