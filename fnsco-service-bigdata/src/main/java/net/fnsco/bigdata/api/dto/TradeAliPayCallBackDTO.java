...
public class TradeAliPayCallBackDTO {
	...
	private String orderDetail;//C	商品详细描述
	...
	private String seqId;//平台交易流水号		M	平台流水号，供后续退货或撤销或对账用
	...
	private String accountFlag;//分账标识		M	Y或N
	private String secMerId;//分账子商户号		M	分账子商户号，accountFlag为Y时有值
