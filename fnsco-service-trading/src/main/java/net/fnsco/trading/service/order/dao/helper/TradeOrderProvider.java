...
public class TradeOrderProvider {
	...
	public String updateByOrderId(Map<String, Object> params) {
		...
		SQL sql = new SQL() {
			{
				...
				if(null != tradeOrder.getEndCreateDate()) {
					WHERE("create_time < #{tradeOrder.endCreateDate}");
				}
