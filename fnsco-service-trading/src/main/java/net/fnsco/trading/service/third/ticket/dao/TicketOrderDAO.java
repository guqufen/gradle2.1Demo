...
public interface TicketOrderDAO {
    ...
    @Results({ @Result(column = "app_user_id", property = "appUserId"), @Result(column = "order_no", property = "orderNo"), @Result(column = "pay_order_no", property = "payOrderNo"),
               @Result(column = "train_date", property = "trainDate"), @Result(column = "from_station_code", property = "fromStationCode"),
               @Result(column = "from_station_name", property = "fromStationName"), @Result(column = "to_station_code", property = "toStationCode"),
               @Result(column = "to_station_name", property = "toStationName"), @Result(column = "train_code", property = "trainCode"), @Result(column = "order_amount", property = "orderAmount"),
