...
//			return JSON.toJSONString(map);
		...
		map.put("orderId", tradeOrderDO1.getOrderNo());//商户订单号
...
//			map.put("respMsg", "系统异常");
	...
	public String CheckAuthid(PassivePayDTO passivePayDTO){
		...
		passDTO.setStdorderid(
				DateUtils.getNowYMDOnlyStr() + passivePayDTO.getStdauthid() + sequenceService.getOrderSequence("t_trade_order"));// 商户订单号，32个字符内
