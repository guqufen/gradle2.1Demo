...
public class TradeConstants extends CoreConstants {
	...
	public static enum BankTypeEnum {
		DC_CARD("DC", "借记卡"), CC_CARD("CC", "贷记卡"), SCC_CARD("SCC", "准贷记卡"), PC_CARD("PC", "预付费卡"), UNK_CARD("UNK", "其他");
		private String code;
		private String name;
		...
		public static String getNameByCode(String code) {
			for (BankTypeEnum eopen : BankTypeEnum.values()) {
	...
	public static enum ZxyhPassivePayCode {
		...
		WX_BS_PAY("481000", "微信被扫支付"), ZFB_BS_PAY("481003", "支付宝被扫支付"), WX_BS_CX("381000",
				"微信交易结果状态查询"), ZFB_BS_CX("381003", "支付宝交易结果状态查询"), WX_AUTH_CK("070101", "微信支付授权码查询交易码");
	...
	public enum TradeTypeEnum {
		WITHDRAW(1, "提现"), INCOME(2, "交易收入"), RED_ENVELOPE(3, "新人红包"), RESE_WITHDRAW(4, "预约提现"), WITHDRAW_FEE(5,
				"提现手续费"), UNDO_INCOME(6, "收入撤销");
		private Integer code;
		private String name;
