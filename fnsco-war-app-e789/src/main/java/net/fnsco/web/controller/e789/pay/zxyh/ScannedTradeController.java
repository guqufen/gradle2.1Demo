...
public class ScannedTradeController extends BaseController {
	...
	/**
	 * 微信扫码接口回调
	 * callBack:(这里用一句话描述这个方法的作用)
	 *
	 * @param  @param respStr    设定文件
	 * @return void    DOM对象
	 * @auth binghui.li 
	...
	public void callBack(String respStr) {
		...
		// 解析json
		TradeWeChatCallBackDTO tradeWeChatCallBackDTO = JSON.parseObject(respJsStr, TradeWeChatCallBackDTO.class);
		if(tradeWeChatCallBackDTO != null){
//			tradeDataService.updateByOrderId(tradeWeChatCallBackDTO);
		}
