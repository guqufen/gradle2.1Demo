...
public class HttpRequest {
    ...
    private static final String[] base64Keys     = new String[] { "subject", "body" };
    private static final String[] base64JsonKeys = new String[] { "customerInfo" };
    ...
    public static String doPost(String urlStr, String payKey, TreeMap<String, String> paramMap, String charSet, int sendType) throws Exception {
        URL url = new URL(urlStr);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod(SERVLET_POST);

        String paramStr = prepareParam(paramMap, sendType, payKey);
    ...
    private static String prepareParam(TreeMap<String, String> paramMap, int sendType, String payKey) {
        CheckSign(paramMap, payKey);
        String result = "";
    ...
    private static void CheckSign(TreeMap<String, String> treeMap, String payKey) {
        String signString = "";
        ...
        signString += payKey; //待签名报文
        logger.info("待签名报文=" + signString);
