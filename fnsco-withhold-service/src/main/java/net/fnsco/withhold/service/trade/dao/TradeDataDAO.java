...
public interface TradeDataDAO {
    ...
    @Results({@Result( column = "withhold_id",property = "withholdId"),@Result( column = "txn_amt",property = "txnAmt"),@Result( column = "fail_reason",property = "failReason"),@Result( column = "user_name",property = "userName"),@Result( column = "bank_card",property = "bankCard"),@Result( column = "sub_bank_name",property = "subBankName"),@Result( column = "an_bank_id",property = "anBankId"),@Result( column = "account_type",property = "accountType"),@Result( column = "txn_type",property = "txnType"),@Result( column = "txn_sub_type",property = "txnSubType"),@Result( column = "biz_type",property = "bizType"),@Result( column = "access_type",property = "accessType"),@Result( column = "mer_id",property = "merId"),@Result( column = "order_sn",property = "orderSn"),@Result( column = "txn_time",property = "txnTime"),@Result( column = "back_url",property = "backUrl"),@Result( column = "pay_type",property = "payType"),@Result( column = "customer_info",property = "customerInfo"),@Result( column = "resp_code",property = "respCode"),@Result( column = "resp_msg",property = "respMsg"),@Result( column = "certif_type",property = "certifType"),@Result( column = "certify_id",property = "certifyId"),@Result( column = "acc_type",property = "accType") })
    @Insert("INSERT into t_trade_data(id,withhold_id,txn_amt,status,fail_reason,user_name,mobile,bank_card,sub_bank_name,an_bank_id,account_type,txn_type,txn_sub_type,biz_type,access_type,mer_id,order_sn,txn_time,currency,back_url,pay_type,subject,body,customer_info,purpose,resp_code,resp_msg,certif_type,certify_id,acc_type) VALUES (#{id},#{withholdId},#{txnAmt},#{status},#{failReason},#{userName},#{mobile},#{bankCard},#{subBankName},#{anBankId},#{accountType},#{txnType},#{txnSubType},#{bizType},#{accessType},#{merId},#{orderSn},#{txnTime},#{currency},#{backUrl},#{payType},#{subject},#{body},#{customerInfo},#{purpose},#{respCode},#{respMsg},#{certifType},#{certifyId},#{accType})")
    ...
    @Results({@Result( column = "withhold_id",property = "withholdId"),@Result( column = "txn_amt",property = "txnAmt"),@Result( column = "fail_reason",property = "failReason"),@Result( column = "user_name",property = "userName"),@Result( column = "bank_card",property = "bankCard"),@Result( column = "sub_bank_name",property = "subBankName"),@Result( column = "an_bank_id",property = "anBankId"),@Result( column = "account_type",property = "accountType"),@Result( column = "txn_type",property = "txnType"),@Result( column = "txn_sub_type",property = "txnSubType"),@Result( column = "biz_type",property = "bizType"),@Result( column = "access_type",property = "accessType"),@Result( column = "mer_id",property = "merId"),@Result( column = "order_sn",property = "orderSn"),@Result( column = "txn_time",property = "txnTime"),@Result( column = "back_url",property = "backUrl"),@Result( column = "pay_type",property = "payType"),@Result( column = "customer_info",property = "customerInfo"),@Result( column = "resp_code",property = "respCode"),@Result( column = "resp_msg",property = "respMsg"),@Result( column = "certif_type",property = "certifType"),@Result( column = "certify_id",property = "certifyId") })
