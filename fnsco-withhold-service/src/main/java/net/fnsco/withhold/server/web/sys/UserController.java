package net.fnsco.withhold.server.web.sys;
...
import net.fnsco.withhold.server.service.sys.UserService;
import net.fnsco.withhold.server.service.sys.entity.UserDO;

@Controller
@RequestMapping(value ="/user", produces = "application/*;charset=utf-8", method = RequestMethod.POST)
@Api(value = "/user", tags = {""})
