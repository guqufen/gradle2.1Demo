 ...
 *
 */
public class OssLoaclUtil {
    static Logger            logger          = LoggerFactory.getLogger(OssLoaclUtil.class);
...
//        }
    ...
    public static void setEndpoint(String endpoint) {
        OssLoaclUtil.endpoint = endpoint;
    }
    ...
    public static void setHeadBucketName(String headBucketName) {
        OssLoaclUtil.headBucketName = headBucketName;
    }
    /**
     * headBucketName
     *
    ...
    */
    ...
    public static String getHeadBucketName() {
        return OssLoaclUtil.headBucketName;
    }
    ...
    public static void setAccessKeyId(String accessKeyId) {
        OssLoaclUtil.accessKeyId = accessKeyId;
    }
    ...
    public static void setAccessKeySecret(String accessKeySecret) {
        OssLoaclUtil.accessKeySecret = accessKeySecret;
    }
