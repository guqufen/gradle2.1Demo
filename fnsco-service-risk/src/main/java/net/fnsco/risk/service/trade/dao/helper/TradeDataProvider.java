...
public class TradeDataProvider {
    ...
    public String update(Map<String, Object> params) {
        ...
        if (StringUtils.isNotBlank(tradeData.getPayMedium())){
            SET("pay_medium=#{tradeData.payMedium}");
        }
        if (StringUtils.isNotBlank(tradeData.getChannelTermCode())){
            SET("channel_term_code=#{tradeData.channelTermCode}");
        }
    ...
    public String pageList(Map<String, Object> params) {
        ...
        if (StringUtils.isNotBlank(tradeData.getPayMedium())){
            WHERE("pay_medium=#{tradeData.payMedium}");
        }
        if (StringUtils.isNotBlank(tradeData.getChannelTermCode())){
            WHERE("channel_term_code=#{tradeData.channelTermCode}");
        }
