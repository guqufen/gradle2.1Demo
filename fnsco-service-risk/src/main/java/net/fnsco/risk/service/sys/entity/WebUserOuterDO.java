...
public class WebUserOuterDO {
	...
	public String toString() {
		return "[id=" + id + ", type=" + type + ", name=" + name + ", password=" + password + ", realName=" + realName
				+ ", mobile=" + mobile + ", email=" + email + ", sex=" + sex + ", aliasName=" + aliasName
				+ ", department=" + department + ", agentId=" + agentId + ", remark=" + remark + ", modifyTime="
				+ modifyTime + ", modifyUserId=" + modifyUserId + ", createrTime=" + createrTime + "]";
	}
}