package net.fnsco.web.controller.syssuggest;
...
public class SysSuggestManageController extends BaseController {
	...
	@ResponseBody
	@RequiresPermissions(value = { "sys:suggest:list" })
	public ResultPageDTO<SysSuggestDTO> query(SysSuggestDTO sysmsg,
			@RequestParam("currentPageNum") Integer currentPageNum, @RequestParam("pageSize") Integer pageSize) {
