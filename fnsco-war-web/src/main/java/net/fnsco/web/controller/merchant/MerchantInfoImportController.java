...
public class MerchantInfoImportController extends BaseController {
    ...
    */
    ...
    public Map<String, String> doImport() {
        ...
        try {
            result = merchantBatchImportToDB(customerList, userId,name);
 ...
 // 批量导入客户
    @Transactional
    public ResultDTO<String> merchantBatchImportToDB(List<Object[]> customerList, Integer userId,String importFileName) throws ParseException {
