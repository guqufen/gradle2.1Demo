...
public interface ConfigDAO {
    ...
    @Results({@Result( column = "order_no",property = "orderNo"), @Result( column = "keep1",property = "keep1") , @Result( column = "modify_time",property = "modifyTime")})
    @Select("SELECT order_no,keep1,modify_time FROM car_config WHERE status=1 AND type='01' ")
    public ConfigDO getIndex();
